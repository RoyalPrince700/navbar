...
const CourseraNavBar = () => {
  ...
  const [businessDrop,setBusinessDrop] = useState(true)
       ...
       className={`absolute right-0 top-[70px] left-0 w-[100vw] h-[100vw] bg-black  ${blackDrop ? 'opacity-75 visible' : 'opacity-0 invisible'}`}>
        ...
        <div onMouseLeave={()=>{
          ...
          <div>
             ...
             <p className='text-slate-700 px-5 hover:shadow-sm py-1 hover:bg-white  hover:text-blue-800 flex items-center cursor-pointer justify-between'>
              ...
              <button className='py-1 px-2 border border-blue-800 ml-5 rounded text-blue-800  font-medium cursor-pointer
