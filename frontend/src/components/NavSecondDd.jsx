...
const {dropVisibleSecond,setDropVisibleSecond} = useContext(SearchContext)
  ...
  return (
    ...
    <div className={`absolute left-[1150px] pt-0 transition-all ${dropVisibleSecond ? 'opacity-100 scale-100' : 'opacity-0 scale-0'}`}>
        ...
        <NavLink to='/' onClick={()=>setDropVisible(false)} className=' gap-3 flex ml-2 mb-2 flex-col '>
